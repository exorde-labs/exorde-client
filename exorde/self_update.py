...
async def self_update():
    try:
        ...
        if latest_tag != local_version:
            exorde_repository_path = "git+https://github.com/exorde-labs/exorde-client.git@chromedriver_fix#subdirectory=exorde&egg=exorde"
            subprocess.check_call(["pip", "install", exorde_repository_path])
            data_repository_path = "git+https://github.com/exorde-labs/exorde-client.git@chromedriver_fix#subdirectory=data&egg=exorde-data"
