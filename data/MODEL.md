...
## Unified item schema
- [schema](https://github.com/exorde-labs/exorde/schema/schema.json) is expressed using [jschemator](https://github.com/exorde-labs/jschemator) and generated using this [schema_workflow](https://github.com/exorde-labs/exorde/.github/workflows/ipfs_schema.yml)
